...
namespace TelegramMetroidvaniaBot.Services
{
    public class MapService
    {
        ...
        {
            // Простая реализация соединений
            if (x1 == x2) // Вертикальное соединение
            {
            ...
            else if (y1 == y2) // Горизонтальное соединение
            {
