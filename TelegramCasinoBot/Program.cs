    ...
    class Program
    {
        ...
        static async Task HandleCallbackQuery(CallbackQuery callbackQuery)
        {
            ...
            try
            {
                ...
                {
                    await _botClient.AnswerCallbackQueryAsync(callbackQuery.Id, "??? Карта обновлена");
        ...
        static async Task DropItem(long chatId, Player player, CallbackQuery callbackQuery)
        {
            ...
            if (player.Inventory.Contains(item))
            {
                ...
                await _botClient.SendTextMessageAsync(chatId, $"??? Вы выбросили {item}. Он остался в этой локации.");
