...
namespace TelegramMetroidvaniaBot.Services
{
    public class WorldFactory
    {
        ...
        {
            new LocationExit("ancient_temple", new Position(5, 0), "north") { Description = "Вы входите в древний храм..." },
            new LocationExit("forbidden_forest", new Position(5, 9), "south") { Description = "Вы углубляетесь в запретный лес..." }
        }
            };
        }
        ...
        private Location CreateAncientTemple()
        {
                    ...
                    ["obstacles"] = new List<Position>
            {
                ...
                Exits = new List<LocationExit>
        {
            new LocationExit("start", new Position(5, 9), "south") { Description = "Вы возвращаетесь к руинам..." },
            new LocationExit("crystal_cave", new Position(5, 0), "north") { Description = "Вы спускаетесь в кристальную пещеру...", RequiredAbility = "Двойной прыжок" }
        }
            };
        }
        ...
        private Location CreateCrystalCave()
        {
                    ...
                    ["obstacles"] = new List<Position>
            {
                ...
                Exits = new List<LocationExit>
        {
            new LocationExit("ancient_temple", new Position(5, 9), "south") { Description = "Вы поднимаетесь обратно в храм..." },
            new LocationExit("boss_chamber", new Position(9, 5), "east") { Description = "Вы входите в зал стражей...", RequiredAbility = "Лазерный луч" }
        }
            };
        }
        ...
        private Location CreateForbiddenForest()
        {
                    ...
                    ["obstacles"] = new List<Position>
            {
                ...
                Exits = new List<LocationExit>
        {
            new LocationExit("start", new Position(9, 5), "east") { Description = "Вы возвращаетесь к руинам..." }
        }
            };
        }
        ...
        private Location CreateBossChamber()
        {
                    ...
                    ["obstacles"] = new List<Position>
            {
                ...
                Exits = new List<LocationExit>
        {
            new LocationExit("crystal_cave", new Position(0, 5), "west") { Description = "Вы отступаете в кристальную пещеру..." },
            new LocationExit("final_sanctum", new Position(5, 0), "north") { Description = "Врата открываются! Вы входите в святилище...", RequiredAbility = "Открытие ворот" }
        }
            };
        }
        ...
        private Location CreateFinalSanctum()
        {
                    ...
                    ["obstacles"] = new List<Position>
            {
                ...
                Exits = new List<LocationExit>
        {
            new LocationExit("boss_chamber", new Position(5, 9), "south") { Description = "Вы возвращаетесь в зал стражей..." }
        }
            };
        }
    }
