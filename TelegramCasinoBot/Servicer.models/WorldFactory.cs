    ...
    public class WorldFactory
    {
        ...
        private Location CreateStartLocation()
        {
            return new Location
            {
                ...
                {
                    new LocationExit { TargetLocationId = "ancient_temple", Position = new Position(5, 0), Direction = "north", Description = "Вы входите в древний храм..." },
                    new LocationExit { TargetLocationId = "forbidden_forest", Position = new Position(5, 9), Direction = "south", Description = "Вы углубляетесь в запретный лес..." }
                }
            };
        }
        ...
        private Location CreateAncientTemple()
        {
            return new Location
            {
                ...
                Exits = new List<LocationExit>
                {
                    new LocationExit { TargetLocationId = "start", Position = new Position(5, 9), Direction = "south", Description = "Вы возвращаетесь к руинам..." },
                    new LocationExit { TargetLocationId = "crystal_cave", Position = new Position(5, 0), Direction = "north", Description = "Вы спускаетесь в кристальную пещеру...", RequiredAbility = "Двойной прыжок" }
                }
            };
        }
        ...
        private Location CreateCrystalCave()
        {
            return new Location
            {
                ...
                Exits = new List<LocationExit>
                {
                    new LocationExit { TargetLocationId = "ancient_temple", Position = new Position(5, 9), Direction = "south", Description = "Вы поднимаетесь обратно в храм..." },
                    new LocationExit { TargetLocationId = "boss_chamber", Position = new Position(9, 5), Direction = "east", Description = "Вы входите в зал стражей...", RequiredAbility = "Лазерный луч" }
                }
            };
        }
        ...
        private Location CreateForbiddenForest()
        {
            return new Location
            {
                ...
                Exits = new List<LocationExit>
                {
                    new LocationExit { TargetLocationId = "start", Position = new Position(9, 5), Direction = "east", Description = "Вы возвращаетесь к руинам..." }
                }
            };
        }
        ...
        private Location CreateBossChamber()
        {
            return new Location
            {
                ...
                Exits = new List<LocationExit>
                {
                    new LocationExit { TargetLocationId = "crystal_cave", Position = new Position(0,5), Direction = "west", Description = "Вы отступаете в кристальную пещеру..." },
                    new LocationExit { TargetLocationId = "final_sanctum", Position = new Position(5,0), Direction = "north", Description = "Врата открываются! Вы входите в святилище...", RequiredAbility = "Открытие ворот" }
                }
            };
        }
        ...
        private Location CreateFinalSanctum()
        {
            return new Location
            {
                ...
                Exits = new List<LocationExit>
                {
                    new LocationExit { TargetLocationId = "boss_chamber", Position = new Position(5,9), Direction = "south", Description = "Вы возвращаетесь в зал стражей..." }
                }
            };
        }
    }
